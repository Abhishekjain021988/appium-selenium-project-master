...
import static com.test.channels.qa.framework.utils.TestUtil.failWithScreenshot;
import static com.test.channels.qa.framework.utils.WaitUtil.waitForElementToBeVisible;

import com.test.channels.qa.framework.utils.TestUtil;
import com.test.channels.qa.framework.utils.WaitUtil;
import com.test.channels.qa.framework.components.enums.VerifyType;
...
public class Component<T extends WebElement> {
     ...
     */
    public Component(MobileDriver driver) {
        super();
        this.driver = driver;
     ...
     * @param driver - the current Appium driver
     */
    public Component(T element, MobileDriver driver) {
        this(driver);
