...
public class WaitUtil {
     ...
     * @param driver - the current driver
     */
    public static void waitForElementToBeVisible(WebElement element, long seconds, WebDriver driver) {
     ...
     * @param driver - the current driver
     */
    public void waitForElementToBeNotPresent(final By locator, WebDriver driver) {
        new WebDriverWait(driver, DEFAULT_WAIT_SECONDS)
