...
public abstract class BaseElements<T extends Component> {
     ...
     *
     */
    protected void init(MobileDriver driver) {
        ...
        for(Field field: privateFields) {
            ...
            MobileElement value = null;
            try {
                value = (MobileElement) FieldUtils.readField(field, this, true);
            } catch (IllegalAccessException e) {
                log.error("Failed initialize elements class for " + this, e);
                throw new FrameworkException(e);
            }

            if(value instanceof MobileElement) {
                // web element and mobile elements we call the custom create method
                components.put(name, this.createComponent(name, value, driver));
     ...
     * @param driver -
     */
    protected void createAdditionalComponents(Map<String, T> components, WebDriver driver) {
     ...
     */
    protected T createComponent(String name, MobileElement element, MobileDriver driver) {
